public class Calculator {
    ...
    public static Polynomial polynomialSubtraction(Polynomial polyReal1, Polynomial polyReal2) {
        Polynomial result = new Polynomial();
        ...
        while (current1 != null && current2 != null) {
            if (current1.exponentX == current2.exponentX && current1.exponentY == current2.exponentY && current1.exponentZ == current2.exponentZ) {
                ...
                if (diffCoefficient != 0) {
                    result.addTerm(new Term(diffCoefficient, current1.exponentX, current1.exponentY, current1.exponentZ));
                }
                current1 = current1.next;
                current2 = current2.next;
            } else if (isTerm1Greater(current1, current2)) {
